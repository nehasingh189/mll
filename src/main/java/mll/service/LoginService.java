...
public class LoginService {
  ...
  /**
   * This method takes http request and response objects as input and first validates the
   * request and if it is valid then it calls DAO to validate the login credentials and
   * return appropriate message to service.
   *
   * @author Vishal Mehta
   * @version 1.0
   * @since 2016-04-06
  ...
  /**
   * This method takes http request as input and validates the request and if it is valid
   * then sets the username and password for a particular user from the request object.
   *
   * @author Vishal Mehta
   * @version 1.0
   * @since 2016-04-06
  ...
  /**
   * This method takes a JSON object as an input and returns a login object containing
