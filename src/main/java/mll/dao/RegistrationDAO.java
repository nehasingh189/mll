...
public class RegistrationDAO {
    ...
    /**
     * Checks whether the given emailId already exists in the database
     * @param emailId email String
     * @return true if emailId already exists, false otherwise
     */
    public Boolean checkAlreadyExists(String emailId) {
        Transaction tx = null;
        Session session = null;
